#!/usr/bin/env python3
"""
Fetch the UCI Cervical Cancer (Risk Factors) dataset (ID=383) using ucimlrepo,
print basic information, and write a CSV with a numeric 'label' + normalized features.

Usage:
  python examples/cervical_cancer/fetch_cervical_cancer.py
...
def main():
    ...
    out_path = os.path.join(script_dir, 'cervical_cancer.csv')
