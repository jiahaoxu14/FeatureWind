#!/usr/bin/env python3
"""
Fetch the UCI Yeast dataset (ID=110) using ucimlrepo,
print basic info, and write a CSV with numeric 'label' + normalized features.

Usage:
  python examples/yeast/fetch_yeast.py
...
def main():
    ...
    # fetch dataset (UCI ID 110: Yeast)
    ds = fetch_ucirepo(id=110)
    ...
    # Numeric label column 'label' (handles string labels)
    ...
    out_path = os.path.join(script_dir, 'yeast.csv')
